...
#     detection = YOLOv8(model, image, args.conf_thres, args.iou_thres)
...
# To test the YOLOv8n model in PyTorch format, you can use the following code:
...
# model_path = "runs/detect/train3/weights/best.pt"  # Substitua pelo caminho do seu modelo
...
# To export the model to ONNX format, you can use the export method as follows:
